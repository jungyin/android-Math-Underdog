...
class Qwen2DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        """
        # np.save("hidden_states.npy",hidden_states.cpu().detach().numpy())
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        outvalue =  BaseModelOutputWithPast(
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        finalout = CausalLMOutputWithPast(
            loss=loss,
            logits=logits,
    ...
    def prepare_inputs_for_generation(
        ...
        if attention_mask is not None and position_ids is None:
            ...
            if past_key_values:
                localindex = -input_ids.shape[1]
                position_ids = position_ids[:, localindex :]
