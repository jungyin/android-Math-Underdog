...
input_model = base_path+"qwen2-code-0.5b/onnx/model32.onnx"

input_model = "D:/code/py/qwen2demo_py/onnx/qwen2_0.5b_test/model.onnx"

output_model = base_path+"qwen2-code-0.5b/openvino_test/model.xml"
output_model = base_path+"qwen2-0.5b/openvino_test/model.xml"
